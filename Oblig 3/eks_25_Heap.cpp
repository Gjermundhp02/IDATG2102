...
//  Heap <unsigned char>  heap2;          //  Bruker 'unsigned char' !!!
  ...
  heap.insert(22); 
  heap.insert(21);
  std::cout << "\n\nHeapen etter innsetting av 12 tall: "; heap.display(); std::cin >> ch;
    heap.insert(39); std::cout << "\n\nHeapen etter innsetting av 39: "; heap.display(); std::cin >> ch;
    heap.insert(59); std::cout << "\n\nHeapen etter innsetting av 59: "; heap.display(); std::cin >> ch;
    heap.remove();   std::cout << "\n\nHeapen etter fjerning av st�rste: "; heap.display(); std::cin >> ch;
    heap.remove();   std::cout << "\n\nHeapen etter fjerning av st�rste: "; heap.display(); std::cin >> ch;
    heap.replace(21); std::cout << "\n\nHeapen etter erstatning av st�rste med 21: "; heap.display(); std::cin >> ch;
