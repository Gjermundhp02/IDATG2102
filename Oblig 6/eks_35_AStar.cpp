...
const int DIMENSJON =    6;         ///<  Antall ruter horisontalt/vertikalt.
const int ARRLEN    = DIMENSJON*101; ///<  Rutens nummer 'i' er indeks nr.'i'.
const int USETT     =  -999;         ///<  IKKE sett - "stort" negativt tall.
const int MAALRUTE =   606;         ///<  Ruten det letes etter.
const int STARTRUTE =   102;         ///<  Ruten det startes � lete fra.
...
char gRutenett[DIMENSJON+2][DIMENSJON+3]
    = { "XXXXXXXX",
        "X      X",
        "X   XX X",
        "XX  X  X",
...
float    gKantVekt[ARRLEN+1];          ///<  'gKantVekt[k]' er TOTAL vekt til
...
bool AStar() {
   int i,                       //  L�kkevariabel
    ...
    float vekt,                    //  TOTAL vekt fra STARTRUTE til 'nabo'.
...
//                               cout << ++ant << ":  " << nr << '\n';
     ...
     for (i = 1;  i <= 8;  i++)  {    //  For hver av naborutene:
       switch (i)  {                  //  Finner deres rutenummer/ID:
         case 1:  nabo = nr-100; tillegg = 1; break; // Rett opp.
         case 2:  nabo = nr-99;  tillegg = 1.41; break; // P� skr� opp til h�yre.
         case 3:  nabo = nr+1;   tillegg = 1; break; // Til h�yre.
         case 4:  nabo = nr+101; tillegg = 1.41; break; // P� skr� ned til h�yre.
         case 5:  nabo = nr+100; tillegg = 1; break; // Rett ned.
         case 6:  nabo = nr+99;  tillegg = 1.41; break; // P� skr� ned til vens.
         case 7:  nabo = nr-1;   tillegg = 1; break; // Til venstre.
         case 8:  nabo = nr-101; tillegg = 1.41; break; // P� skr� opp til vens.
       }
...
*/
       ...
       if ((gRutenett[y][x] != 'X')  &&  (gKantVekt[nabo] < 0))  {
          ...
          cout << "rute: " << nabo << "  vekt: " << tillegg << "  heuristics: " << heuristics(nabo) << '\n';
