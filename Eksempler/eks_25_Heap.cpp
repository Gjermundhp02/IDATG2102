...
//  Heap <unsigned char>  heap2;          //  Bruker 'unsigned char' !!!
  ...
  heap.insert('S');  std::cout << "\nInsert 1 :  "; heap.display(); 
  heap.insert('M');  std::cout << "\nInsert 5 :  "; heap.display(); 
  heap.insert('I');  std::cout << "\nInsert 2 :  "; heap.display(); 
  heap.insert('T');  std::cout << "\nInsert 6 :  "; heap.display(); 
  heap.insert('T'); std::cout << "\nReplace 4:  "; heap.display(); 
  heap.insert('E');   std::cout << "\nRemove   :  "; heap.display();
  heap.insert('V');  std::cout << "\nInsert 7 :  "; heap.display(); 
  heap.insert('E');  std::cout << "\nInsert 3 :  "; heap.display(); 
  heap.insert('R');  std::cout << "\nInsert 3 :  "; heap.display(); 
  heap.insert('N');  std::cout << "\nInsert 3 :  "; heap.display(); 
