 ...
 *     for � f� p� plass et element, for en tabell som er mindre enn 2/3 full.
 *     DOUBLE HASHING bruker gjennomsnittlig f�rre 'probes' enn linear probing.
 *     SEPARATE CHAINING reduserer antall sammenligninger ved sekvensielt s�k
 *     med en gjennomsnittlig faktor p�  M,  n�r det er M stacker/LIFO-lister.
 *
...
class  Hashing {
  private:
      ...
      int kVerdi(char bokstav) {          //  Gj�r om A-Z til 1-26:
  ...
  public:
      ...
      void insert(const int hashVerdi, const char data) {
          int dataTilK = kVerdi(data);                //  F�r 'k' for 'data'.
       ...
       cout << data << "   k: " << dataTilK     //  Skriver disse verdiene:
          ...
          tabell[indeks] = data;         //  Setter inn p� ledig funnet plass.
                                                     display();
      }
};
